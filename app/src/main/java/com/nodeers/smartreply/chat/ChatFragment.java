...
import com.nodeers.smartreply.model.Message;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

public class ChatFragment extends Fragment implements ReplyAdapter.ClickListener{
    ...
    private ReplyAdapter mChipAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mChipAdapter = new ReplyAdapter(this);
